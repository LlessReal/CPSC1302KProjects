public class Pets1 {
    ...
    public String toString() {
        String TheName = "Name: " + this.name; // Name: the name
    ...
    public static void main(String[] args) {
        ...
        Pets Pet1 = new Pets("Joe Bulldog"); // New object named Pet1 whose name is Joe Biden
        Pets Pet2 = new Pets(""); // New object called Pet2 that has no name yet
        Pet2.setPetName("TrumPawg"); // Use set method to set the name
